...
expats.controller('cultureController', function($scope, $timeout, Session, WikiEndpoint, $http){

  //content for text

  if (Session.city == "New York"){
    var country = "New_York_City";
  }
  ...
  if (theaddress){
    ...
    .then(function (res) {
          $scope.culs = res.data.query.pages;
    });
  }else{
          $scope.culs = "";
          $scope.culture = "Sorry, there is no content yet.";
  }
